...
public class BillingServlet extends HttpServlet {
	...
	@EJB(mappedName = "java:module/SubscriberBillingInfoImpl!com.ericsson.eea.billing.service.SubscriberBillingRemote")
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      id.setId(msisdn != null ? msisdn : "123123123123");
			...
			resp = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(bean.getBillingCycleInfo(filter));
		...
		/*
		 * String htmlRespone = "<html>"; htmlRespone +=
		 * "<h2> Billing Response <br></h2>"; htmlRespone += "<div> " + resp + "</div";
		 * htmlRespone += "</html>";
		 */
