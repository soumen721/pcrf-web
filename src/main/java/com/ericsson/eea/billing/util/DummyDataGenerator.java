...
public class DummyDataGenerator {
	...
	public static GetCurrentAndAvailableDataProductsResponse populateResponseData()
		...
		DataPass dataPass = populateDataPass("C", "10GB Data EE HS EOBC",
				...
				LocalDateTime.now().minusDays(DAY_IN_MNTH * CUR_MONTH_CYCLE + 4), 8667008000L, 8960598016L, "virtual",
		...
		DataPass dataPass2 = populateDataPass("ZR", "Apple app",
				...
				LocalDateTime.now().minusDays(DAY_IN_MNTH * CUR_MONTH_CYCLE + 14), 28711212L, 10737418240L, "virtual",
				new Long[] { 7904909312L, 7904932423L });
		DataPass dataPass3 = populateDataPass("E", "EE AutoFUP HS_100GB",
				LocalDateTime.now().minusDays(DAY_IN_MNTH * CUR_MONTH_CYCLE + 27),
				LocalDateTime.now().minusDays(DAY_IN_MNTH * CUR_MONTH_CYCLE + 16), 287161212L, 213123123L, "virtual",
		...
		DataPass dataPass4 = populateDataPass("ZR", "Video1",
				...
				LocalDateTime.now().minusDays(DAY_IN_MNTH * CUR_MONTH_CYCLE + 18), 2871612L, 213123123L, "virtual",
		...
		DataPass dataPass20 = populateDataPass("E", "10GB Data EE HS EOBC",
				...
				LocalDateTime.now().minusDays(DAY_IN_MNTH * PENLTY_MONTH_CYCLE + 4), 125823338L, 1073742330L, "virtual",
				new Long[] { 866721321L, 2942488576L });
		DataPass dataPass21 = populateDataPass("EZR", "AFUP_CON_HS_UKEU_DCC",
				...
				LocalDateTime.now().minusDays(DAY_IN_MNTH * PENLTY_MONTH_CYCLE + 5), 287161232L, 118322228L, "virtual",
				new Long[] { 896023286L, 2852495360L });
